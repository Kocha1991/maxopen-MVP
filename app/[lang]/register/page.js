          ...
          <section className='section-box box-content-register'>
            <div className='container'>
              <div className='text-center contact-head'>
                <span className='btn btn-brand-5'>Sign Up</span>
                <h2 className='heading-2 neutral-0 mb-20 mt-15'>
                  Registration
                </h2>
                    ...
                    <div className='col-lg-7 mb-40'>
                      <div className='box-form-register'>
                        ...
                        <p className='text-md neutral-700'>
                          ...
                          <Link className='brand-1-1' href='/login'>
                            Sign in
                          </Link>
                        </p>
                        <form className='form-register' action='#'>
                          <div className='form-group'>
                            <label>
                              Your Name<span className='brand-1'>*</span>
                            </label>
                            <input
                          ...
                          <div className='form-group'>
                            <label>
                              Your Email<span className='brand-1'>*</span>
                            </label>
                            <input
                              className='form-control'
                              type='text'
                          ...
                          <div className='form-group-cb'>
                            <label className='text-md'>
                              <input className='cb-agree' type='checkbox' />I
                              agree to terms conditions
                            </label>
                          </div>
                          <div className='form-group'>
                            <button className='btn btn-black btn-rounded'>
                              Sign Up
                              <svg
                          ...
                          <div className='other-login'>
                            ...
                            <div className='box-button-register'>
                              ...
                              <Link className='btn btn-login' href='#'>
                                <img
                                  src='/assets/imgs/page/register/twitter.svg'
                                  alt='Nivia'
                                />
                              </Link>
                              <Link className='btn btn-login' href='#'>
                                <img
                                  src='/assets/imgs/page/register/linkedin.svg'
                                  alt='Nivia'
                                />
                              </Link>
                              <Link className='btn btn-login' href='#'>
                                <img
                                  src='/assets/imgs/page/register/github.svg'
                                  alt='Nivia'
                                />
                              </Link>
                            </div>
                    ...
                    <div className='col-lg-5 mb-40'>
                      <div className='box-border-rounded'>
                        <div className='card-casestudy'>
                          <div className='card-title'>
                            <h6>
                              <span className='number'>1</span>Signup for
                              Service
                            </h6>
                          </div>
                          <div className='card-desc'>
                            <p>
                              ...
                              enables you to access tailored solutions and
                              special offers swiftly, ensuring you can quickly
                              begin enjoying our services.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className='box-border-rounded'>
                        <div className='card-casestudy'>
                          <div className='card-title'>
                            <h6>
                              <span className='number'>2</span>Research
                              Development
                            </h6>
                          </div>
                          <div className='card-desc'>
                            <p>
                              ...
                              solutions to ensure they reflect your goals and
                      ...
                      <div className='box-border-rounded'>
                        <div className='card-casestudy'>
                          ...
                          <div className='card-desc'>
                            <p>
                              We monitor performance, optimize campaigns, and
                              make certain that you attain the results you
                              anticipate. This is the ultimate step to ensure
                              you are well on your way to achieving success and
                              revenue from your project.
                            </p>
                          </div>
                        </div>
                      </div>
