            ...
            <Layout useCustomHeader={true} footerStyle={'customFooter'} logoWhite>
                <section className="section-box wow animate__animated animate__fadeIn box-404">
                    <div className="text-center"><img src="/assets/imgs/page/404/404.png" alt="Nivia" />
                        ...
                        <p className="text-lg neutral-500 mb-35">The page you are looking for doesn't exist or has been moved</p><Link className="btn btn-brand-4-medium hover-up animation-btn-svg" href="/">Back to Home Page
