          ...
          <div className='box-how-help-inner'>
            <div className='container'>
              <div className='text-center box-help-mw'>
                ...
                <p className='text-lg neutral-500 mb-50'>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit
                  lobortis arcu enim urna
                  <br className='d-none d-lg-block' />
                  adipiscing praesent velit viverra sit semper draconius.
                </p>
          ...
          <div className='container'>
            <div className='text-center box-help-mw'>
              ...
              <p className='text-lg neutral-500 mb-50'>
                ...
                mollis est <br className='d-none d-lg-block' />
            ...
            <div className='row'>
              <div className='col-lg-4 col-md-6'>
                <div className='card-question'>
                  <div className='card-image'>
                    {' '}
                    <img src='/assets/imgs/page/help/bill.png' alt='Nivia' />
                  </div>
                  <div className='card-info'>
                    <h5>Billing and Payments</h5>
                    <div className='meta-post'>
                      {' '}
                      <span className='text-sm topic'>32 topics </span>
                      <span className='text-sm article'>168 articles </span>
                    </div>
                    <p className='text-md neutral-600'>
                      Suspendisse vestibulum vitae enim a porta. Etiam pulvinar
                      risus vitae turpis sagittis, sit amet placerat ipsum
                      euismod. Morbi semper velit risus, ut convallis tortor
                      bibendum vel. Morbi enim ex, elementum nec elit vel,
                      gravida commodo augue.
                    </p>
                  </div>
                </div>
              </div>
              <div className='col-lg-4 col-md-6'>
                <div className='card-question bg-1'>
                  <div className='card-image'>
                    {' '}
                    <img src='/assets/imgs/page/help/trouble.png' alt='Nivia' />
                  </div>
                  <div className='card-info'>
              ...
              <div className='col-lg-4 col-md-6'>
                <div className='card-question bg-2'>
                  <div className='card-image'>
                    {' '}
                    <img
                      src='/assets/imgs/page/help/integration.png'
                      alt='Nivia'
                    />
                  </div>
                  <div className='card-info'>
              ...
              <div className='col-lg-4 col-md-6'>
                <div className='card-question bg-3'>
                  <div className='card-image'>
                    {' '}
                    <img src='/assets/imgs/page/help/started.png' alt='Nivia' />
                  </div>
                  <div className='card-info'>
              ...
              <div className='col-lg-4 col-md-6'>
                <div className='card-question bg-4'>
                  <div className='card-image'>
                    {' '}
                    <img src='/assets/imgs/page/help/account.png' alt='Nivia' />
                  </div>
                  <div className='card-info'>
              ...
              <div className='col-lg-4 col-md-6'>
                <div className='card-question bg-5'>
                  <div className='card-image'>
                    {' '}
                    <img src='/assets/imgs/page/help/advance.png' alt='Nivia' />
                  </div>
                  <div className='card-info'>
          ...
          <div className='container'>
            <div className='box-list-prices'>
              <div className='text-center'>
                ...
                <h2 className='mb-45 mt-15'>
                  Need Any Help ?<br className='d-none d-lg-block' /> Read
                  Popular Questions
                </h2>
              </div>
              <div className='row'>
                <div className='col-md-6'>
                  <div className='card-faq card-faq-black'>
                    ...
                    <div className='item-info'>
                      <p className='text-md'>
                        With it profitable sure wrong continued in the queen's
                        perhaps and simple fat denied adding worthy little use
                        as some he so high down am week conduct esteems by
                        cottage to pasture.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='card-faq card-faq-black'>
                    <div className='item-title'>
                      <h6>
                        ...
                        Does Nivia share my information with others?
                      </h6>
                    </div>
                    <div className='item-info'>
                      <p className='text-md'>
                        ...
                        besides add. Moonlight newspaper. the queen's perhaps
                        and simple fat denied adding worthy little use as some
                        he so high
                      </p>
                    </div>
                  </div>
            ...
            <div className='block-more-question'>
              <div className='question-left'>
                ...
                <p className='text-lg mb-20'>
                  If you still can’t find the answer you’re looking for, let we
                  help you.
                </p>
