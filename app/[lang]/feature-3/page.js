              ...
              <div className='row align-items-center'>
                <div className='col-lg-6'>
                  ...
                  <p className='text-lg neutral-500 mb-25'>
                    Let's browse through all the great features you'll get when
                    <br className='d-none d-lg-block' />
                    you're in the Nivia ecosystem
                  </p>
                </div>
                <div className='col-lg-6'>
                  <div className='box-banner-feature'>
                    {' '}
                    <img
                      src='/assets/imgs/page/features/banner.png'
                      alt='Nivia'
                    />
                ...
                <div className='row align-items-center'>
                  <div className='col-lg-6 mb-40 text-center text-lg-start'>
                    <div className='image-feature-2'>
                      <img
                        src='/assets/imgs/page/features/img-track.png'
                        alt='Nivia'
                      />
                    </div>
                  </div>
                      ...
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            ...
                            <p className='text-md neutral-700'>
                              An infrastructure plan outlines a comprehensive
                              strategy for designing, building
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            ...
                            <p className='text-md neutral-700'>
                              Signifies the enhancement of security measures,
                              typically through the use of advanced firewall
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            ...
                            <p className='text-md neutral-700'>
                              Involves overseeing an organization's technology
                              resources, including hardware, software, networks
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className='box-border-rounded'>
                <div className='row align-items-center'>
                    ...
                    <div className='row mt-50'>
                      ...
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            ...
                            <p className='text-md neutral-700'>
                              Strategy in the context of business and marketing
                              refers to a long-term plan
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            ...
                            <p className='text-md neutral-700'>
                              Development in the marketing context refers to the
                              creation, refinement
                            </p>
                          </div>
                        </div>
                      ...
                      <div className='col-lg-6 col-md-6'>
                        <div className='card-feature-2'>
                          ...
                          <div className='card-info'>
                            <Link href='#'>
                              <h3 className='text-22-bold'>Data Analysis</h3>
                            </Link>
                            <p className='text-md neutral-700'>
                              Data analysis in marketing involves the
                              interpretation and examination of data to generate
                              insights
                            </p>
                          </div>
                        </div>
                  ...
                  <div className='col-lg-6 mb-40 text-center text-lg-end'>
                    <div className='image-feature-2'>
                      <img
                        src='/assets/imgs/page/features/img-track2.png'
                        alt='Nivia'
                      />
                    </div>
                  </div>
                  ...
                  <div className='box-border-rounded-md'>
                    <div className='row align-items-center'>
                      <div className='col-md-7 mb-30'>
                        <h4 className='mb-20'>
                          Save your time and money by choosing our professional
                          team
                        </h4>
                        <p className='text-md neutral-700'>
                      ...
                      <div className='col-md-5 mb-30 text-center text-md-end'>
                        <img src='/assets/imgs/page/features/save-time.png' />
                      </div>
                    </div>
                  </div>
                </div>
                <div className='col-lg-6'>
                  <div className='box-border-rounded-md'>
                    <div className='row align-items-center'>
                      ...
                      <div className='col-md-5 mb-30 text-center text-md-end'>
                        <img src='/assets/imgs/page/features/convin.png' />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className='row'>
                <div className='col-lg-4 col-md-6'>
                  <div className='card-question card-question-2'>
                    <div className='card-image'>
                      <img
                        src='/assets/imgs/page/features/internet.png'
                        alt='Nivia'
                      />
                    </div>
                    <div className='card-info'>
                ...
                <div className='col-lg-4 col-md-6'>
                  <div className='card-question card-question-2'>
                    <div className='card-image'>
                      <img
                        src='/assets/imgs/page/features/train.png'
                        alt='Nivia'
                      />
                    </div>
                    <div className='card-info'>
                ...
                <div className='col-lg-4 col-md-6'>
                  <div className='card-question card-question-2'>
                    <div className='card-image'>
                      <img
                        src='/assets/imgs/page/features/pricing.png'
                        alt='Nivia'
                      />
                    </div>
                    <div className='card-info'>
