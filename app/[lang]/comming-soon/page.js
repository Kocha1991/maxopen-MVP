          ...
          <div className='container-fluid'>
            <div className='row'>
              <div className='col-lg-7'>
                <div className='box-comming-soon-banner'>
                  <span className='btn btn-brand-4-sm'>Coming Soon</span>
                  ...
                  <div className='form-notify'>
                    <form action='#'>
                      ...
                      />
                      <button className='btn btn-black btn-rounded btn-notify'>
                        Notify Me
                        <svg
                  ...
                  <div className='box-socials-commingsoon'>
