                ...
                <div className='row'>
                  <div className='col-lg-9 mb-40'>
                    ...
                    <ul className='list-check-black'>
                      <li>5,000 Monthly Word Limit</li>
                      <li>5,000 Monthly Word Limit</li>
                      <li>50+ Languages</li>
                      <li>50+ Languages</li>
                    ...
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6 id='step-2'>
                          <span className='number'>2</span>Privacy Policy
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                    ...
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6 id='step-3'>
                          <span className='number'>3</span>User Policy
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                    ...
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6 id='step-4'>
                          <span className='number'>4</span>Copyrights
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                    ...
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6 id='step-5'>
                          <span className='number'>5</span>Cookies
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                    ...
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6 id='step-6'>
                          <span className='number'>6</span>Account Billing
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
