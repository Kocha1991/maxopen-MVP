              ...
              <div className='container'>
                <div className='text-center'>
                  ...
                  <h2 className='heading-2 mb-15 mt-15'>
                    Choose the right price plan
                    <br className='d-none d-lg-block' /> that suitable for you
                  </h2>
                  ...
                  <div className='text-center mb-75'>
                    <span className='text-lg text-billed'>Monthly</span>
                    ...
                    <span className='text-lg text-billed'>Annually</span>
                  </div>
                </div>
                    ...
                    <div className='col-md-6'>
                      <div className='card-faq card-faq-black'>
                        ...
                        <div className='item-info'>
                          <p className='text-md'>
                            With it profitable sure wrong continued in the
                            queen's perhaps and simple fat denied adding worthy
                            little use as some he so high down am week conduct
                            esteems by cottage to pasture.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='card-faq card-faq-black'>
                        ...
                        <div className='item-info'>
                          <p className='text-md'>
                            ...
                            besides add. Moonlight newspaper. the queen's
                            perhaps and simple fat denied adding worthy little
                            use as some he so high
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <Swiper {...swiperOptions} className='swiper-wrapper'>
                    <SwiperSlide>
                      <div className='card-testimonial'>
                        ...
                        <div className='card-comment'>
                          <p className='text-md'>
                            As a small business most owner, effective
                            communication and collaboration are key to success.
                            this app's<Link href='#'>team collaboration</Link>{' '}
                            with feature has and helped us get things donefaster
                            the interface is user-friendly
                          </p>
                        </div>
                        <div className='card-author'>
                          <div className='author-info'>
                            <span className='text-md author-name mr-10'>
                              ROBERT FOX
                            </span>
                            <span className='text-lg neutral-500'>@Amazon</span>
                          </div>
                    ...
                    <SwiperSlide>
                      <div className='card-testimonial'>
                        ...
                        <div className='card-comment'>
                          <p className='text-md'>
                            Little in examination transmitting the and country
                            with it profitable sure wrong continued in the
                            queen's perhaps and simple fat denied adding worthy
                            little use as some he so high down am week conduct
                            esteems by cottage to pasture Little in examination
                            transmitting the and country
                          </p>
                        </div>
                        <div className='card-author'>
                          <div className='author-info'>
                      ...
                      <div className='card-testimonial'>
                        ...
                        <div className='card-comment'>
                          <p className='text-md'>
                            ...
                            this app's<Link href='#'>team collaboration</Link>{' '}
                            with feature has and helped us get things donefaster
                            the interface is user-friendly Comfort reached gay
                            perhaps chamber his six detract besides add.
                            Moonlight newspaper up its enjoyment agreeable
                            depending Comfort reached gay perhaps chamber his
                            six
                          </p>
                        </div>
                        <div className='card-author'>
                      ...
                      <div className='card-testimonial'>
                        ...
                        <div className='card-comment'>
                          <p className='text-md'>
                            As a small business most owner, effective
                            communication and collaboration are key to success.
                            this app's with feature has and helped us get things
                            donefaster the interface is user-friendly Little in
                            examination transmitting the and country with it
                            profitable sure wrong continued in the queen's
                            perhaps and simple fat denie
                          </p>
                        </div>
                        <div className='card-author'>
                          <div className='author-info'>
                          ...
                          <div className='author-image'>
                            <img
                              src='/assets/imgs/page/homepage6/author4.png'
                              alt='Nivia'
                            />
                          </div>
                        </div>
              ...
              <div className='block-more-question'>
                <div className='question-left'>
                  ...
                  <p className='text-lg mb-20'>
                    If you still can’t find the answer you’re looking for, let
                    we help you.
                  </p>
