              ...
              <div className='list-features-2'>
                <div className='item-list-feature'>
                  <div className='feature-left'>
                    ...
                    <Link href='#'>
                      <img
                        src='/assets/imgs/page/features/img-feature.png'
                        alt='Nivia'
                      />
                    </Link>
                  </div>
                  <div className='feature-right'>
                    <h4 className='heading-4 mb-20'>
                      Access to the latest online courses to learn new tech and
                      trends
                    </h4>
                ...
                <div className='item-list-feature'>
                  <div className='feature-left'>
                    ...
                    <Link href='#'>
                      <img
                        src='/assets/imgs/page/features/img-feature2.png'
                        alt='Nivia'
                      />
                    </Link>
                  </div>
                  <div className='feature-right'>
                    <h4 className='heading-4 mb-20'>
                      Monthly tracked skill and work quality improvements
                    </h4>
                    <p className='text-lg neutral-700'>
                    ...
                    <div className='box-list-checked'>
                      <ul className='list-checked'>
                        ...
                        <li>
                          Push for and create inclusive, accessible design for
                          all
                        </li>
                        <li>
                ...
                <div className='item-list-feature'>
                  <div className='feature-left'>
                    ...
                    <Link href='#'>
                      <img
                        src='/assets/imgs/page/features/img-feature3.png'
                        alt='Nivia'
                      />
                    </Link>
                  </div>
                  <div className='feature-right'>
                    <h4 className='heading-4 mb-20'>
                      The Traditional Way of Hiring Creative Freelancers is
                      Broken
                    </h4>
                    <p className='text-lg neutral-700'>
                      End-to-end payments and financial management in a single
                      solution. Download our app and start your free trail to
                      get started today!
                    </p>
                    <div className='box-list-check'>
                      <ul className='list-check'>
