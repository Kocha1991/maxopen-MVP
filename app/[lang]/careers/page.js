    ...
    <>
      ...
      >
        <div>
                ...
                <div className='banner-inner'>
                  <div className='box-banner-left'>
                    ...
                    <h1 className='display-2 mb-30 mt-25'>
                      Exciting Career <br className='d-none d-lg-block' />
                      Opportunities Await
                    </h1>
                    <p className='text-lg neutral-500 mb-55'>
                      Find to open shifts based on the location, types of work,
                      and our business rating Work for the most.
                    </p>
                    <div className='d-flex mb-60'>
                      <Link className='btn btn-brand-4-border' href='#'>
                        <svg
                          width={41}
                          height={41}
                          viewBox='0 0 41 41'
                        ...
                        >
                          <path
                            d='M22 4.50032L18.4791 0.979492V3.8074H0V5.19333H18.4791V8.02129L22 4.50032Z'
                            fill='#191919'
                          />
                        </svg>
                      </Link>
                  ...
                  <div className='box-banner-right'>
                    <div className='box-images-banner-6'>
                      <img
                        src='/assets/imgs/page/careers/banner.png'
                        alt='Nivia'
                      />
                    </div>
                  </div>
              ...
              <div className='row align-items-center'>
                <div className='col-lg-6 mb-40'>
                  <div className='image-feature-2'>
                    <img
                      src='/assets/imgs/page/homepage3/img-feature.png'
                      alt='Nivia'
                    />
                  </div>
                </div>
                <div className='col-lg-6 mb-40'>
                  ...
                  <p className='text-lg neutral-700'>
                    ...
                    Explained propriety off out perpetual.
                  </p>
                  <div className='row mt-50'>
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-feature-2'>
                        ...
                        <div className='card-info'>
                          <Link href='#'>
                            <h3 className='text-22-bold'>Career growth</h3>
                          </Link>
                    ...
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-feature-2'>
                        ...
                        <div className='card-info'>
                          <Link href='#'>
                            <h3 className='text-22-bold'>Great culture</h3>
                          </Link>
                          <p className='text-md neutral-700'>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Aspernatur, iste
                    ...
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-feature-2'>
                        ...
                        <div className='card-info'>
                          <Link href='#'>
                            <h3 className='text-22-bold'>Flexible hours</h3>
                          </Link>
                          <p className='text-md neutral-700'>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Aspernatur, iste
                    ...
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-feature-2'>
                        ...
                        <div className='card-info'>
                          <Link href='#'>
                            <h3 className='text-22-bold'>Competitive salary</h3>
                          </Link>
                          <p className='text-md neutral-700'>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Aspernatur, iste
          ...
          <section className='section-box box-open-job'>
            <div className='container'>
              <div className='text-center'>
                <span className='btn btn-brand-4-sm'>Job openings</span>
                <h2 className='heading-2 mb-20 mt-15'>Open job position</h2>
                <p className='text-lg'>
                ...
                <div className='box-button-preparing'>
                  <Link className='btn btn-neutral-100' href='#'>
                    IT Management
                  </Link>
                  <Link className='btn btn-neutral-100' href='#'>
                    Data Security
                    ...
                    <div className='card-job'>
                      ...
                      <div className='card-info'>
                        <p className='text-md neutral-500'>
                          ...
                          elit lobortis arcu enim urna adipiscing praesent velit
                          viverra Saas is a easy process of darkzai. Donec vel
                          sapien in sapien convallis malesuada.
                        </p>
            ...
            <div className='container'>
              <div className='text-center'>
                ...
                <h2 className='mt-15 mb-20'>
                  How to apply to the Nivia platform
                  <br className='d-none d-lg-block' />
                  and growing your career
                </h2>
                <p className='text-lg neutral-500 mb-55'>
                  Bole nostrud exercitation ullamco laboris nisi ut aliquip ex
                  ea commodo conididunt ut labore et dolore magna aliqua ut enim
                  ad minim veniam
                </p>
              </div>
              <div className='row'>
                  ...
                  <div className='box-border-rounded'>
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6>
                          {' '}
                          <span className='number'>1</span>Find the Job sources
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                          Simple and cost effective to run high-performance
                          queries on petabytes of semi-structured and structured
                          data so that you can build powerful reports and
                          dashboards.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className='box-border-rounded'>
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6>
                          {' '}
                          <span className='number'>2</span>Submit your CV
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
                  ...
                  <div className='box-border-rounded'>
                    <div className='card-casestudy'>
                      <div className='card-title'>
                        <h6>
                          {' '}
                          <span className='number'>3</span>Interview
                        </h6>
                      </div>
                      <div className='card-desc'>
                        <p>
