            ...
            <div className='container'>
              <div className='text-center'>
                ...
                <h2 className='mt-15 mb-15'>
                  What You Get From Nivia Platform
                </h2>
                  ...
                  >
                    <SwiperSlide>
                      <div className='card-testimonial-2'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/homepage5/review1.png'
                            alt='Nivia'
                          />
                        </div>
                        <div className='card-info'>
                          <div className='card-logo'>
                            <img
                              src='/assets/imgs/page/homepage5/minty.png'
                              alt='Nivia'
                            />
                          </div>
                          <div className='card-comment'>
                            <p className='text-md neutral-700'>
                              “Discover what sets this apart as the market's
                              easiest and most powerful video interviewing
                              platform, and why hiring managers consistently
                              choose us over the competition Discover what sets
                              this apart as the market's easiest and most
                              powerful video interviewing platform, and why
                              hiring managers consistently choose us over the
                              competitionDiscover what sets this apart as the
                              market's easiest and most powerful video
                              interviewing platform, and why hiring managers
                          ...
                          <div className='card-author'>
                            ...
                            <div className='card-rates'>
                              <img
                                src='/assets/imgs/page/homepage5/star-sm.svg'
                                alt='Nivia'
                              />
                              <img
                                src='/assets/imgs/page/homepage5/star-sm.svg'
                    ...
                    <SwiperSlide>
                      <div className='card-testimonial-2'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/homepage5/review2.png'
                            alt='Nivia'
                          />
                        </div>
                        <div className='card-info'>
