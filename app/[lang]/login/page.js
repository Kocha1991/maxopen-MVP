                  ...
                  <form className='form-register' action='#'>
                    ...
                    <div className='other-login mt-45'>
                      <p className='text-md neutral-500'>
                        ...
                        <Link className='brand-1-1' href='/register'>
                          Sign Up
                        </Link>
                      </p>
                    </div>
                  ...
                  <ul className='list-logos-login'>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo2.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo3.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo4.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo5.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo6.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo7.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo8.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo9.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
                    <li>
                      <div className='item-logo'>
                        <img
                          src='/assets/imgs/page/homepage3/logo1.png'
                          alt='Nivia'
                        />
                      </div>
                    </li>
